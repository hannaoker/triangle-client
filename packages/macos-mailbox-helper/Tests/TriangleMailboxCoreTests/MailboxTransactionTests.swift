...
struct MailboxTransactionTests {
    ...
    @Test("claimNext scopes selection to the allowed room")
    func claimNextRoomScope() async throws { try await MailboxTransactionContractCases.claimNextScopesAllowedRoom() }
