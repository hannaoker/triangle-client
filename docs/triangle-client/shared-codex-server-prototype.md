...
Status: protocol proof and native desktop idle-chat wake-up passed; not production integration.

Next agent: start with [the concrete implementation handoff](codex-desktop-wake-handoff.md).
